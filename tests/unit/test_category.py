...
class TestCategory(unittest.TestCase):
    ...
    def test_category_initialization(self):
        ...
        self.assertEqual(category.name, self.name, "El nombre de la categoría no coincide")
        self.assertEqual(category.url, self.url, "La URL de la categoría no coincide")
        self.assertEqual(category.selectors, self.selectors, "Los selectores no coinciden")
    ...
    def test_get_selector_valid_key(self):
        ...
        self.assertEqual(selector, "//span[@class='price']", "Selector incorrecto para 'price_selector'")
    ...
    def test_get_selector_invalid_key_returns_none(self):
        ...
        self.assertIsNone(selector, "Se esperaba None al consultar un selector inexistente")
